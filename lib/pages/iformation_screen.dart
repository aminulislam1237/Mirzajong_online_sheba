      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            _buildInfoRow('যোগাযোগ', 'ঢাকা থেকে বরিশাল-বাকেরগঞ্জ-মির্জাগঞ্জ-চান্দখালী-বরগুনা মহাসড়কে অবস্থিত। মির্জাগঞ্জ উপজেলাটি পটুয়াখালী জেলা শহর থেকে '
                '১৭ কি: মি: পশ্চিমে শ্রীমন্ত নদীর দক্ষিনে অবস্থিত। বরগুনা - মির্জাগঞ্জ ভায়া চান্দখালী   ২৯   কি:মি:। বাকেরগঞ্জ- মির্জাগঞ্জ  ২৮  কি:মি:। বেতাগী - '
                'মির্জাগঞ্জ  ১০ কি: মি:। রাজধানী ঢাকা থেকে সড়কপথে ২১৮ কিমি দূরত্বে মির্জাগঞ্জ উপজেলা অবস্থিত'),
            ...
            _buildInfoRow('অবস্থান', 'মির্জাগঞ্জ উপজেলার শ্রীমন্ত নদী ও পায়রা নদীর তীরে ২২-৩র্ হতে ২২-২৯র্ উত্তর অক্ষাংশ এবং ৯০-০৮র্ হতে ৯০-১৯র্ পুর্ব দ্রাঘিমাংশে অবস্থিত।'),
            _buildInfoRow('সীমানা',
            ...
            _buildInfoRow('নদ-নদী', 'পায়রা নদী, শ্রীমন্ত নদী'),
